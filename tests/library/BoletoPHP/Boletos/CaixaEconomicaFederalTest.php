...
class CaixaEconomicaFederalTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetViewVars()
    {
        ...
        $this->assertEquals($view_vars['sacado'], 'Luiz Fernando Popota');
        ...
        // $this->assertEquals($view_vars['codigo_barras'], file_get_contents(__DIR__.'/../../../fixtures/codigo_de_barras_caixa_economica_federal'));
    }
}
