...
$myArguments = array(
  'library_location'       => 'boleto-lib', //adjust to the location where you have stored Boleto's library. If it is outside your current application folder you gotta use ../
