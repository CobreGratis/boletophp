            ...
            <div id="boleto">
                ...
                <div class="grid-container">
                    ...
                    <div class="canhoto">
                        ...
                        <table class="line" cellspacing="0" cellPadding="0">
                            <tbody>
                                ...
                                <tr class="campos">
                                    <td class="vencimento2 line"><?php echo $dadosboleto["data_vencimento"] ?></td>
                                </tr>
                                <tr class="titulos">
                                    <td class="ag_cod_cedente ">Agência / Código do Cedente</td>
                                </tr>
                                <tr class="campos">
                                    <td class="ag_cod_cedente line"><?php echo $dadosboleto["agencia_codigo"] ?> &nbsp;</td>
                                </tr>
                                <tr class="titulos">
                                    <td class="nosso_numero">Nosso número</td>
                                </tr>
                                <tr class="campos">
                                    <TD class="nosso_numero line"><?php echo $dadosboleto["nosso_numero"] ?>&nbsp;</td>
                                </tr>
                                <tr class="titulos">
                                    <td class="valor_doc">(=) Valor documento</TD>
                                </tr>
                                <tr class="campos">
                                    <td class="valor_doc line"><b><?php echo $dadosboleto["valor_boleto"] ?></td>
                                </tr>
                                <tr class="titulos">
                                    <td class="vencimento2">N° Parcela</td>
                                </tr>
                                <tr class="campos">
                                    <td class="vencimento2 line">1 </td>
                                </tr>
                                <tr class="titulos">
                                    <td class="desconto">(-) Desconto / Abatimento</td>
                                </tr>
                                <tr class="campos">
                                    <td class="desconto line">&nbsp;</td>
                                </tr>
                                <tr class="titulos">
                                    <td class="outras_deducoes">(-) Outras dedu&ccedil;&otilde;es</td>
                                </tr>
                                <tr class="campos">
                                    <td class="outras_deducoes line">&nbsp;</td>
                                </tr>
                                <tr class="titulos">
                                    <td class="mora_multa">(+) Mora / Multa</td>
                                </tr>
                                <tr class="campos">
                                    <td class="mora_multa line">&nbsp;</td>
                                </tr>
                                <tr class="titulos">
                                    <td class="outros_acrescimos">(+) Outros acr&eacute;scimos</td>
                                </tr>
                                <tr class="campos">
                                    <td class="outros_acrescimos line">&nbsp;</td>
                                </tr>
                                <tr class="titulos">
                                ...
                                <tr class="campos">
                                    <td class="valor_cobrado line" style="text-align: right;"><b>&nbsp;<?php echo $dadosboleto["valor_cobrado"] ?></b></td>
                                </tr>
                                <tr class="titulos">
                    ...
                    <div class="pagar">
                        ...
                        <table class="line" cellspacing="0" cellPadding="0">
                            <tbody>
                                ...
                                <tr class="campos">
                                    ...
                                    <td class="valor_doc2"><b><?php echo $dadosboleto["valor_boleto"] ?></b></td>
                                </tr>
                            </tbody>
                        </table>
                                    ...
                                    <td class="last_line">
                                        <table class="line" cellspacing="0" cellpadding="0">
                                            <tbody>
                                                ...
                                                <tr class="campos">
                                                    <td class="valor_cobrado2" style="text-align: right;"><b>&nbsp;<?php echo $dadosboleto["valor_boleto"] ?></b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                            ...
                            <tbody>
                                ...
                                <tr class="campos">
                                    <td class="sacado2">
                                        ...
                                        <p><?php echo $dadosboleto["endereco1"] ?><?php echo $dadosboleto["endereco2"] ?></p>
                        ...
                        <p style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensa&ccedil;&atilde;o</p>
