...
$dadosboleto["cedente_uf"]     = "Estado";
$dadosboleto["cedente_cidade"] = "Cidade";
$dadosboleto["cidade_uf"]      = "{$dadosboleto['cedente_cidade']} / {$dadosboleto['cedente_uf']}";
$dadosboleto["cedente"]        = "Coloque a Razão Social da sua empresa aqui";
$dadosboleto["cedente_cep"]    = 'CEP de Empresa';

// Pasta onde estão armazenadas as imagens do boletophp (padrão em branco)
$assetsUrl = '';

// Arquivo onde está o logo da empresa
$logoUrl   = $assetsUrl.'imagens/logo_empresa.png';
