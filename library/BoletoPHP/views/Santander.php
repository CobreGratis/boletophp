...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    ...
    <td class=ti width=455><?php echo $identificacao; ?> <?php echo isset($cpf_cnpj) ? "<br>".$cpf_cnpj : '' ?><br>
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=126 height=12> 
  ...
  <?phpecho $ponto_venda." <img src='imagens/b.png' width=10 height=1> ".$tmp2?>
  </span></td>
...
mec�nica - <b class=cp>Ficha de Compensa��o</b></div></TD></TR><TR><TD class=ct  colspan=3 ></TD></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 width=666 border=0><TBODY><TR><TD vAlign=bottom align=left height=50><?php fbarcode($codigo_barras); ?> 
 </TD>
