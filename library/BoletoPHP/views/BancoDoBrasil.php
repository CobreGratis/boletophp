...
<div id="container">
	...
	<div id="instr_header">
		<h1><?php echo $identificacao; ?> <?php echo isset($cpf_cnpj) ? $cpf_cnpj : '' ?></h1>
...
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tr class="campos">
			...
			<td class="ag_cod_cedente"><?php echo $agencia_codigo?> &nbsp;</td>
		...
		<tr class="campos">
			...
			<td class="ag_cod_cedente2"><?php echo $agencia_codigo?></td>
		</tr>
		</tbody>
		</table>
