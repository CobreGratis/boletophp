...
class CaixaEconomicaFederalSIGCB {
    ...
    private function geraAgenciaCodigo(){
    ...
    private function geraCodigoBanco() {
    ...
    private function monta_linha_digitavel() {
            $codigo = $this->linha;
